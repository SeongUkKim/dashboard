...
<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyCi1q30hkCUhgC4f_hlABjz8CI5__MeQnc" ></script>
        ...
        },
        {
            ...
            markLine : {
                ...
                data : [
                    ...
                    [{name:'KR'}, {name:'VN',value:90}],
                    [{name:'KR'}, {name:'JP',value:60}]
